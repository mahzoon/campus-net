...
import net.campus.client.database.DataManager;
import net.campus.client.database.Note;
import net.campus.client.database.User;
...
public class GoogleDriveSyncService implements SyncNoteService {
	...
	static String folder_id = "0B9mU-w_CpbztLTVpYi1QQTNJNlk";
	static String users_file_name = "Users_uncc.txt";
	static String users_file_desc = "A Complete List of All the UNCC Users";
	static String users_file_title = "Users_uncc";
	static String ideas_file_name = "Ideas_uncc.txt";
	static String ideas_file_desc = "A Complete List of All the Design Ideas for UNCC";
	static String ideas_file_title = "Ideas_uncc";
