...
//import net.campus.client.views.EditCategoryView;
import net.campus.client.views.EditLandmarkView2;
import net.campus.client.views.EditNoteTextView;
import net.campus.client.views.EditParkActivityView;
import net.campus.client.views.TouchImageView;
