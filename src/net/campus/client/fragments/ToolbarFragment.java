package net.campus.client.fragments;

import java.io.File;

import net.campus.client.GoogleDriveSyncService;
import net.campus.client.R;
import net.campus.client.activities.ActivitiesActivity;
import net.campus.client.activities.GalleryActivity;
import net.campus.client.activities.MainMapActivity;
import net.campus.client.activities.NoteActivity;
import net.campus.client.activities.UserActivity;
import net.campus.client.database.ApplicationData;
import net.campus.client.database.Note;
import net.campus.client.database.Notebook;
...
//		});
	...
	public void invokeIdea() {
		...
		.setMessage("Here you can submit your design idea about the CampusNet project:")
		.setView(input)
