...
import net.campus.client.AlbumStorageDirFactory;
import net.campus.client.FroyoAlbumDirFactory;
import net.campus.client.GoogleDriveSyncService;
import net.campus.client.ImgurSyncService;
import net.campus.client.SyncNoteService;
