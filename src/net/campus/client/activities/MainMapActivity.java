package net.campus.client.activities;

import net.campus.client.OnLandmarkSelectionEventListener;
import net.campus.client.R;
import net.campus.client.R.id;
import net.campus.client.TouchMapImageView;
import net.campus.client.database.ApplicationData;
import net.campus.client.database.Landmark;
import net.campus.client.fragments.ToolbarFragment;
import net.campus.client.views.LandmarkView;
